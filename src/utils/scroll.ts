...
const scrollTo = (x = 0, y:any) => {
  window.scrollTo(x, y)
}

const scrollRandomScreen = (x = 0, min: any, max: any) => {
...
export const scrollRandomY = (type: any, i = 0, args: any, timeout: any) => {
  try {
...
export const scrollElement = (type: any, args: any, index: any, timeout: any) => {
  try {
    return new Promise(resolve => {

...
export const actionsTest = async (args: any) => {
  try {
...
export const actionClick = async (type: any, args: any, timeout: any) => {
  try {
    return new Promise(resolve => {
      let isClicked = false
...
export const actionClickChild = async (type: any, args: any, timeout: any) => {
  try {
    return new Promise(resolve => {
      let isClicked = false
      const els = document.querySelectorAll(args.parent)
...
export const actionClickChildIndex = async (type: any, args: any, timeout: any) => {
  try {
    return new Promise(resolve => {
      let isClicked = false
      const els = document.querySelectorAll(args.parent)
...
export const actionClickChildFind = async (type: any, args: any, timeout: any) => {
  try {
    return new Promise(resolve => {
      let isClicked = false
      const reg = new RegExp("(.*)" + args.text + "(.*)")
...
export const actionClickModalButton = async (type: any, args: any, timeout: any) => {
  try {
    return new Promise(resolve => {
      let isClicked = false
      const els = document.querySelectorAll(args.el)
...
export const actionClickChildModalButton = async (type: any, args: any, timeout: any) => {
  try {
    return new Promise(resolve => {
      let isClicked = false
      const els = document.querySelectorAll(args.parent)
